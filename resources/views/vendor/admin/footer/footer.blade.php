                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="alert alert-primary text-center text-bold" role="alert">Footer 1</div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ $footer->link11 }}" name="link11" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 1 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Two Link</label>
                          <input type="text" value="{{ $footer->link12 }}" name="link12" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 2 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Three Link</label>
                          <input type="text" value="{{ $footer->link13 }}" name="link13" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 3 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Four Link</label>
                          <input type="text" value="{{ $footer->link14 }}" name="link14" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 4 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ $footer->link15 }}" name="link15" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 5 link">
                        </div>

                        <div class="form-group">
                          <div class="alert alert-primary text-center text-bold" role="alert">Footer 4</div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field One Link</label>
                          <input type="text" value="{{ $footer->link16 }}" name="link16" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 1 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Two Link</label>
                          <input type="text" value="{{ $footer->link17 }}" name="link17" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 2 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Three Link</label>
                          <input type="text" value="{{ $footer->link18 }}" name="link18" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 3 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Four Link</label>
                          <input type="text" value="{{ $footer->link19 }}" name="link19" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 4 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Two Link</label>
                          <input type="text" value="{{ $footer->link22 }}" name="link22" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 2 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Three Link</label>
                          <input type="text" value="{{ $footer->link23 }}" name="link23" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 3 link">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">Field Four Link</label>
                          <input type="text" value="{{ $footer->link24 }}" name="link24" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Field 4 link">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="alert alert-primary text-center text-bold" role="alert">Footer 3</div>
